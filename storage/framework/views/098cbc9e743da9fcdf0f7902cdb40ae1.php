    ...
    <div class="max-w-md mx-auto my-8 p-6 bg-white rounded-lg shadow-lg">
        ...
        <form action="<?php echo e(route('contacts.update', $contact->id)); ?>" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" placeholder="Enter Name" value="<?php echo e(old('name', $contact->name)); ?>" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="phone" id="phone" placeholder="+90 xxx xxxxxxxx Phone" value="<?php echo e(old('phone', $contact->phone)); ?>" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\assignment\resources\views/contacts/edit.blade.php ENDPATH**/ ?>